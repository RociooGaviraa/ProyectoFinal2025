    ...
    <div className="min-h-screen flex justify-center items-center px-4 bg-gradient-to-br from-pink-100 via-blue-50 to-yellow-50">
      <div className="sm:mx-auto sm:w-full sm:max-w-lg flex flex-col items-center -mt-8 mb-8">
        <img
          src={logo}
          alt="Eventfy Logo"
          className="h-16 w-16 mb-0 drop-shadow-lg"
        />
        <h2 className="text-center text-3xl font-bold text-blue-900 mb-1 tracking-tight">
          Crea tu cuenta
        </h2>
        <p className="text-center text-base text-pink-600 font-semibold mb-4">
          ¡Únete a Eventfy!
        </p>
