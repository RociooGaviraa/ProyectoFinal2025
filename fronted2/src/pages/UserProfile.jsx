                            ...
                            {userEventsWithAttendees.length > 0 ? (
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    {userEventsWithAttendees.map(event => (
                                        <div key={event.id} className="bg-white rounded-2xl shadow-md overflow-hidden relative transition hover:shadow-lg flex flex-col h-full">
                                            {/* Imagen */}
                                            <img
                                            ...
                                            <div className="p-5 flex flex-col flex-1 justify-between">
                                                {/* Título */}
                                                <h3 className="text-lg font-semibold text-gray-900 break-words min-h-[3rem] mb-2">
                                                    {event.title}
                                                </h3>
                                                {/* Fecha y ubicación */}
                                                <div className="flex flex-col gap-1 mb-2">
                                                    ...
                                                    <div className="flex items-center text-sm text-gray-500 gap-2">
                                                        ...
                                                        <span className="truncate max-w-[180px] block" title={event.location}>
                                                            {event.location}
                                                        </span>
                                                    </div>
                                                </div>
